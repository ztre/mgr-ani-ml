...
def _extract_subtitle_lang(filename: str) -> str | None:
    ...
    has_zh_cn = (
        "简中" in name_lower or "简体" in name_lower
        or has_token(["sc", "chs", "gb", "zh-hans", "zh-cn"])
    )
    has_zh_tw = (
        "繁中" in name_lower or "繁体" in name_lower or "繁體" in name_lower
        or has_token(["tc", "cht", "big5", "zh-hant", "zh-tw"])
    )
